...
namespace Hero_List
{
    ...
    Hero Him(       "Him",       Gender::Male,   Role::Might, Faction::Neutral,    Team::Red,     0, 0, 8, 7, 0, 0, Specialty_List::None,    Morale::Neutral,  Luck::Neutral, { false, false, false, false }, false );
    Hero Her(       "Her",       Gender::Female, Role::Might, Faction::Neutral,    Team::Tan,     0, 0, 2, 3, 0, 0, Specialty_List::None,    Morale::Terrible, Luck::Superb,  { false, false, false, false }, false );
