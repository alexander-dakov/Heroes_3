...
namespace Creature_List
{
    ...
    const Creature Titan (               "Titan",               Faction::Tower,      7, true,   1, true,  24, 24, 24, 40, 60, 300, 11, Morale::Good,    Luck::Neutral, 5000, 7500, { 5000, 0, 0, 0, 2 }, "Ranged attack. No melee penalty. Immune to mind spells. Hates Black Dragons.");
    ...
    const Creature Beholder (            "Beholder",            Faction::Dungeon,    3, false,  7, true,   9,  7, 12,  3,  5,  22,  5, Morale::Good,    Luck::Neutral,  240,  336, {  250, 0, 0, 0, 0 }, "Ranged attack. No melee penalty.");
    const Creature Evil_Eye (            "Evil Eye",            Faction::Dungeon,    3, true,   7, true,  10,  8, 24,  3,  5,  22,  7, Morale::Good,    Luck::Neutral,  245,  367, {  280, 0, 0, 0, 0 }, "Ranged attack. No melee penalty.");
    const Creature Medusa (              "Medusa",              Faction::Dungeon,    4, false,  4, false,  9,  9,  4,  6,  8,  25,  5, Morale::Good,    Luck::Neutral,  379,  517, {  300, 0, 0, 0, 0 }, "Ranged attack. No melee penalty. 20% chance to cast Petrify per melee attack.");
    const Creature Medusa_Queen (        "Medusa Queen",        Faction::Dungeon,    4, true,   4, false, 10, 10,  8,  6,  8,  30,  6, Morale::Good,    Luck::Neutral,  423,  577, {  330, 0, 0, 0, 0 }, "Ranged attack. No melee penalty. 20% chance to cast Petrify per melee attack.");
