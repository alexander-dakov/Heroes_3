...
namespace Creature_List
{
    ...
    // Fortress
    const Creature Gnoll (               "Gnoll",               Faction::Fortress,   1, false, 12, false,  3,  5,  0,  2,  3,   6,  4, Morale::Good,    Luck::Neutral,   70,   56, {   50, 0, 0, 0, 0 }, "");
    const Creature Gnoll_Marauder (      "Gnoll Marauder",      Faction::Fortress,   1, true,  12, false,  4,  6,  0,  2,  3,   6,  5, Morale::Good,    Luck::Neutral,   90,   90, {   70, 0, 0, 0, 0 }, "");
    const Creature Lizardman (           "Lizardman",           Faction::Fortress,   2, false,  9, false,  5,  6, 12,  2,  3,  14,  4, Morale::Good,    Luck::Neutral,  115,  126, {  110, 0, 0, 0, 0 }, "Ranged attack.");
    const Creature Lizard_Warrior (      "Lizard Warrior",      Faction::Fortress,   2, true,   9, false,  6,  8, 24,  2,  5,  15,  5, Morale::Good,    Luck::Neutral,  130,  156, {  140, 0, 0, 0, 0 }, "Ranged attack.");
    const Creature Serpent_Fly (         "Serpent Fly",         Faction::Fortress,   3, false,  8, false,  7,  9,  0,  2,  5,  20,  9, Morale::Good,    Luck::Neutral,  215,  268, {  220, 0, 0, 0, 0 }, "Casts Dispel to benefical spells per attack.");
    const Creature Dragon_Fly (          "Dragon Fly",          Faction::Fortress,   3, true,   8, false,  8, 10,  0,  2,  5,  20, 13, Morale::Good,    Luck::Neutral,  250,  312, {  240, 0, 0, 0, 0 }, "Casts Dispel to benefical spells per attack. Casts advanced Weakness per attack.");
    const Creature Basilisk (            "Basilisk",            Faction::Fortress,   4, false,  4, true,  11, 11,  4,  6, 10,  35,  5, Morale::Good,    Luck::Neutral,  506,  552, {  325, 0, 0, 0, 0 }, "20% chance to cast Petrify per attack.");
    const Creature Greater_Basilisk (    "Greater Basilisk",    Faction::Fortress,   4, true,   4, true,  12, 12,  8,  6, 10,  40,  7, Morale::Good,    Luck::Neutral,  561,  714, {  400, 0, 0, 0, 0 }, "20% chance to cast Petrify per attack.");
    const Creature Gorgon (              "Gorgon",              Faction::Fortress,   5, false,  3, true,  10, 14,  0, 12, 16,  70,  5, Morale::Good,    Luck::Neutral,  890,  890, {  525, 0, 0, 0, 0 }, "");
    const Creature Mighty_Gorgon (       "Mighty Gorgon",       Faction::Fortress,   5, true,   3, true,  11, 16,  0, 12, 16,  70,  6, Morale::Good,    Luck::Neutral, 1028, 1028, {  600, 0, 0, 0, 0 }, "10% chance to cast Death Stare per melee attack.");
    const Creature Monarch (             "Monarch",             Faction::Fortress,   6, false,  2, true,  14, 14,  0, 14, 18,  70,  7, Morale::Good,    Luck::Neutral, 1050, 1350, {  800, 0, 0, 0, 0 }, "");
    const Creature Wyvern_Monarch (      "Wyvern Monarch",      Faction::Fortress,   6, true,   2, true,  14, 14,  0, 18, 22,  70, 11, Morale::Good,    Luck::Neutral, 1518, 1518, { 1100, 0, 0, 0, 0 }, "30% chance to cast Poison per attack.");
    const Creature Hydra (               "Hydra",               Faction::Fortress,   7, false,  1, true,  16, 18,  0, 25, 45, 175,  5, Morale::Good,    Luck::Neutral, 4120, 4120, { 2200, 0, 0, 0, 0 }, "Attack all adjacent enemies. No enemy retaliation.");
    const Creature Chaos_Hydra (         "Chaos Hydra",         Faction::Fortress,   7, true,   1, true,  18, 20,  0, 25, 45, 250,  7, Morale::Good,    Luck::Neutral, 5272, 5931, { 3500, 0, 1, 0, 0 }, "Attack all adjacent enemies. No enemy retaliation.");
    ...
    const Creature Wolf_Rider (          "Wolf Rider",          Faction::Stronghold, 2, false,  9, true,   7,  5,  0,  2,  4,  10,  6, Morale::Good,    Luck::Neutral,  130,  130, {  100, 0, 0, 0, 0 }, "");
    const Creature Wolf_Raider (         "Wolf Raider",         Faction::Stronghold, 2, true,   9, true,   8,  5,  0,  3,  4,  10,  8, Morale::Good,    Luck::Neutral,  174,  203, {  140, 0, 0, 0, 0 }, "Double attack.");
    const Creature Orc (                 "Orc",                 Faction::Stronghold, 3, false,  7, false,  8,  4, 12,  2,  5,  15,  4, Morale::Good,    Luck::Neutral,  175,  192, {  150, 0, 0, 0, 0 }, "Ranged attack.");
    const Creature Orc_Chieftain (       "Orc Chieftain",       Faction::Stronghold, 3, true,   7, false,  8,  4, 24,  2,  5,  20,  5, Morale::Good,    Luck::Neutral,  200,  240, {  165, 0, 0, 0, 0 }, "Ranged attack.");
    ...
    const Creature Roc (                 "Roc",                 Faction::Stronghold, 5, false,  3, true,  13, 11,  0, 11, 15,  60,  7, Morale::Good,    Luck::Neutral,  790, 1027, {  600, 0, 0, 0, 0 }, "");
    const Creature Thunderbird (         "Thunderbird",         Faction::Stronghold, 5, true,   3, true,  13, 11,  0, 11, 15,  60, 11, Morale::Good,    Luck::Neutral,  869, 1106, {  700, 0, 0, 0, 0 }, "20% chance to cast Lightning Strike per attack.");
    const Creature Cyclops (             "Cyclops",             Faction::Stronghold, 6, false,  2, false, 15, 12, 16, 16, 20,  70,  6, Morale::Good,    Luck::Neutral, 1055, 1266, {  750, 0, 0, 0, 0 }, "Ranged attack. Can attack siege walls.");
    const Creature Cyclops_King (        "Cyclops King",        Faction::Stronghold, 6, true,   2, false, 17, 13, 24, 16, 20,  70,  8, Morale::Good,    Luck::Neutral, 1110, 1443, { 1100, 0, 0, 0, 0 }, "Ranged attack. Can attack siege walls.");
